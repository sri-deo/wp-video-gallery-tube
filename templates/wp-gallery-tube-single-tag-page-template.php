                            ...
                            <div class="main-title">
                                <div class="btn-group float-right right-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="<?=isset($_GET['sort'])?(preg_replace(array("#\&sort=([A-Za-z]+)\S*#","#\?sort=([A-Za-z]+)\S*#"), array("&sort=length-high","?sort=length-high"), $_SERVER['REQUEST_URI'])):  ( isset($_GET['page_n']) ? ($_SERVER['REQUEST_URI'].'&sort=length-high') : ($_SERVER['REQUEST_URI'].'?sort=length-high') )  ?>"><i class="fas fa-fw fa-signal"></i> &nbsp; Length High</a>
                                        <a class="dropdown-item" href="<?=isset($_GET['sort'])?(preg_replace(array("#\&sort=([A-Za-z]+)\S*#","#\?sort=([A-Za-z]+)\S*#"), array("&sort=length-low","?sort=length-low"), $_SERVER['REQUEST_URI'])):  ( isset($_GET['page_n']) ? ($_SERVER['REQUEST_URI'].'&sort=length-low') : ($_SERVER['REQUEST_URI'].'?sort=length-low') )  ?>"><i class="fas fa-fw fa-signal"></i> &nbsp; Length Low</a>
                                    </div>
                                </div>
                                <h6>Videos</h6>
                            </div>
